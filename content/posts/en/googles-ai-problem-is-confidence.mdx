...
date: "2026-08-05"
description: "Alphabet's AI numbers are huge, and Google has now reorganized the people around them. Demis Hassabis becomes Alphabet's chief scientist, Koray Kavukcuoglu takes over Google DeepMind, and Jeff Dean moves into a new AI venture. The uncomfortable question is whether organizational design can restore release confidence."
...
## Update: Google reorganized the confidence problem

On August 5, Google made the subtext explicit.

In a company memo published as [The next chapter of our AI momentum](https://blog.google/company-news/inside-google/message-ceo/next-chapter-ai-momentum/), Sundar Pichai announced that Demis Hassabis is moving from day-to-day leadership of Google DeepMind into a broader role as chair of Google DeepMind and chief scientist of Alphabet, while still leading Isomorphic Labs. Koray Kavukcuoglu, Google DeepMind's CTO and Google's chief AI architect, will step up as SVP of Google DeepMind and oversee Gemini model development, frontier AI research, the Gemini app, and developer teams. Jeff Dean and Sanjay Ghemawat are leaving their Google operating roles to launch an independent public-benefit corporation focused on ML, science, and engineering, with Alphabet staying involved as a founding investor and Cloud partner.

That is not a normal org chart tweak.

It is Google trying to split the AI problem into two clocks.

One clock is frontier-product execution: Gemini releases, the app, developer tools, AI Mode, Cloud customers, agent platforms, latency, cost, and the visible shipping rhythm that investors and builders can feel. That clock now belongs more directly to Koray.

The other clock is AGI, scientific discovery, external legitimacy, and long-horizon research narrative. That clock now belongs more visibly to Demis.

This may be smart.

It may even be necessary.

But it also confirms the earlier thesis of this piece: Google's AI challenge is no longer "does Google have enough AI assets?" It obviously does. The challenge is whether those assets can be arranged into a machine that produces confidence.

The market heard the same signal in a harsher language. [Business Insider reported](https://www.businessinsider.com/google-ai-leadership-demis-hassabis-steps-down-deepmind-ceo-2026-8) that Alphabet shares fell as much as 5% on the news, and folded the move into the larger anxiety around Jeff Dean's departure, earlier senior AI exits, Gemini delays, and rising AI spending.

That reaction may be too jumpy.

Jeff Dean leaving to build another AI-science company with Alphabet backing is not the same thing as Jeff Dean defecting to a rival. Demis stepping back from operations is not the same thing as Google losing its AI soul. Koray is not an outsider parachuted into a system he does not understand; he has been at DeepMind since the early days.

Still, this is why AI talent now behaves like infrastructure.

When a company is spending hundreds of billions on compute, every senior-model-leadership change becomes part of the capex story. Who decides the roadmap? Who owns the release bar? Who resolves tension between product speed and research caution? Who keeps the model teams, app teams, developer teams, Cloud teams, and safety teams moving in one direction? Who gives developers a reason to believe Gemini is not only powerful, but reliably on time?

Very glamorous. The AI race has discovered middle management.

The next Google question is not whether Demis can talk about AGI with more altitude.

It is whether Koray can make Gemini feel less like a collection of strong ingredients and more like an operating system for AI momentum.
