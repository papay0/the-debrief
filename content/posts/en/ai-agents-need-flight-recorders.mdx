...
date: "2026-08-25"
description: "Alabama's subpoena to OpenAI turns the flight-recorder argument into a legal test. The useful lesson is not that one state attorney general has found wrongdoing. He has not. It is that agent incidents now need records detailed enough for regulators, customers, and victims to reconstruct what actually happened."
