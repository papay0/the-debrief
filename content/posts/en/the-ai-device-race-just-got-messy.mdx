...
date: "2026-08-04"
description: "Apple's lawsuit against OpenAI is still only a set of allegations, and OpenAI has now published its own rebuttal. The bigger shift remains the same: the AI race is moving from model launches into devices, supply chains, recruiting, IP, and proof of clean-room discipline."
