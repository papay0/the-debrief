...
date: "2026-08-12"
description: "Le lancement de GPT-5.6 comptait. Mais ChatGPT Work était le signal le plus clair : les agents quittaient les réponses pour l'exécution. Les nouveaux Enterprise Signals d'OpenAI donnent maintenant les reçus : les entreprises qui prennent de l'avance ne chatent pas seulement davantage. Elles donnent aux agents du contexte, des outils, de la persistance, des permissions et des boucles de revue."
...
Le 12 août, OpenAI a publié [deux rapports sur l'adoption enterprise](https://openai.com/index/how-enterprises-put-ai-to-work/) et une mise à jour de son tableau [Enterprise Signals](https://openai.com/signals/enterprise-data/). Le titre utile n'est pas "plus de gens posent des questions à ChatGPT".
