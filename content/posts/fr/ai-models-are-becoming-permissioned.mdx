...
date: "2026-08-07"
description: "La Maison-Blanche a maintenant finalisé un cadre confidentiel de revue des modèles frontier, selon WIRED et The Guardian. Le problème n'est plus seulement de savoir qui obtient l'accès aux modèles. C'est de savoir si le règlement lui-même est assez lisible pour que builders, startups, développeurs open model et public puissent planifier."
