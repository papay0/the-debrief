...
date: "2026-08-05"
description: "Les chiffres IA d'Alphabet sont énormes, et Google vient de réorganiser les personnes autour de ces chiffres. Demis Hassabis devient chief scientist d'Alphabet, Koray Kavukcuoglu prend la tête de Google DeepMind, et Jeff Dean part vers une nouvelle aventure IA. La question gênante est de savoir si l'organisation peut restaurer la confiance dans le rythme."
...
## Mise à jour : Google réorganise le problème de confiance

Le 5 août, Google a rendu le sous-texte explicite.

Dans un mémo publié sous le titre [The next chapter of our AI momentum](https://blog.google/company-news/inside-google/message-ceo/next-chapter-ai-momentum/), Sundar Pichai annonce que Demis Hassabis quitte la direction opérationnelle quotidienne de Google DeepMind pour devenir chair de Google DeepMind et chief scientist d'Alphabet, tout en continuant de diriger Isomorphic Labs. Koray Kavukcuoglu, CTO de Google DeepMind et chief AI architect de Google, devient SVP de Google DeepMind et supervisera le développement des modèles Gemini, la recherche frontier, l'app Gemini et les équipes développeurs. Jeff Dean et Sanjay Ghemawat quittent leurs rôles opérationnels chez Google pour lancer une public-benefit corporation indépendante centrée sur le machine learning, la science et l'ingénierie, avec Alphabet comme investisseur fondateur et partenaire Cloud.

Ce n'est pas un petit changement d'organigramme.

C'est Google qui essaie de séparer le problème IA en deux horloges.

La première horloge, c'est l'exécution produit frontier : les sorties Gemini, l'app, les outils développeurs, AI Mode, les clients Cloud, les plateformes agentiques, la latence, les coûts et le rythme de shipping que les investisseurs et les builders peuvent sentir. Cette horloge revient désormais plus directement à Koray.

La deuxième horloge, c'est l'AGI, la découverte scientifique, la légitimité externe et le récit de recherche à long terme. Cette horloge revient plus visiblement à Demis.

C'est peut-être intelligent.

C'est même peut-être nécessaire.

Mais cela confirme aussi la thèse initiale de cet article : le problème IA de Google n'est plus de savoir si Google possède assez d'actifs IA. Évidemment que oui. Le problème est de savoir si ces actifs peuvent être organisés en une machine qui produit de la confiance.

Le marché a entendu le même signal dans une langue plus brutale. [Business Insider rapporte](https://www.businessinsider.com/google-ai-leadership-demis-hassabis-steps-down-deepmind-ceo-2026-8) que l'action Alphabet a perdu jusqu'à 5% après l'annonce, et relie le mouvement à l'inquiétude plus large autour du départ de Jeff Dean, d'autres départs récents de leaders IA, des retards de Gemini et de la hausse des dépenses IA.

Cette réaction est peut-être trop nerveuse.

Jeff Dean qui part construire une autre entreprise IA-science avec le soutien d'Alphabet, ce n'est pas Jeff Dean qui rejoint un rival. Demis qui prend de la distance avec l'opérationnel, ce n'est pas Google qui perd son âme IA. Koray n'est pas un externe parachuté dans un système qu'il ne comprend pas ; il est chez DeepMind depuis les débuts.

Mais c'est précisément pour cela que le talent IA se comporte maintenant comme de l'infrastructure.

Quand une entreprise dépense des centaines de milliards en compute, chaque changement de leadership autour des modèles devient une partie de l'histoire capex. Qui décide la roadmap ? Qui possède la barre de lancement ? Qui arbitre entre vitesse produit et prudence de recherche ? Qui garde les équipes modèles, app, développeurs, Cloud et safety dans la même direction ? Qui donne aux développeurs une raison de croire que Gemini n'est pas seulement puissant, mais fiable dans son rythme ?

Très glamour. La course IA vient de découvrir le middle management.

La prochaine question pour Google n'est pas de savoir si Demis peut parler d'AGI avec plus de hauteur.

C'est de savoir si Koray peut faire en sorte que Gemini ressemble moins à une collection d'excellents ingrédients et plus à un système d'exploitation pour la dynamique IA.
