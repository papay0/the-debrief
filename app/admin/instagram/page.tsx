...
import { InstagramGenerator } from "./instagram-generator";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-14">
        <header className="mb-10">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl font-semibold tracking-tight leading-[1.15] text-foreground">
            Instagram Mini Reels
          </h1>
          <p className="text-muted-foreground mt-3 text-[15px] sm:text-base leading-relaxed max-w-xl">
            Generate 4-second animated news cards. Pick an article, customize
            the headline and TLDR, choose a gradient, and export as MP4.
          </p>
          <div className="w-8 h-0.5 bg-primary mt-6" />
        </header>
        <InstagramGenerator posts={posts} />
      </div>
    </div>
  );
}
