...
import { Sparkles, BarChart3, Film, ArrowRight } from "lucide-react";
          ...
          >
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Generate 4-second animated news cards. Bold headline,
                  2-line TLDR, gradient background. Optimized for reach.
                </p>
              </div>
              <ArrowRight className="w-4 h-4 text-border group-hover:text-muted-foreground transition-colors shrink-0 mt-1" />
            </div>
